...
| Recommendation | `recommendation_app` | Opportunities, scenarios and interactions |
...
| Workbench BFF | `workbench_bff_app` | Entitled read model for the RM workbench |
