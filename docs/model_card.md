...
read: `config/mlflow_promotion_policy.json` declared gate ids for two transitions
and was only ever grepped for substrings. It is now machine-read as a catalogue
of **24 gates across 4 transitions**, and the published document is generated
